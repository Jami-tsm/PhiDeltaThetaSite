...
🔗 [View Live Site](https://phi-delta-theta-site.vercel.app)
...
2. **Open locally:**
   Open any `.html` file directly in your browser, or use a local server for PHP support:
   ```bash
...
All logos, colors, and brand materials were sourced from the official [Phi Delta Theta Brand Portal](https://brand.phideltatheta.org) and are used in compliance with the fraternity's Identity & Style Guidelines.
...
- [Jameson Baker (Jami-tsm)](https://github.com/Jami-tsm)
- [jjb1390](https://github.com/jjb1390)
